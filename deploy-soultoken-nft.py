#!/usr/bin/env python3
"""
Deploy our custom SoulToken NFT contract
"""
...
print("🚀 Deploying SoulToken NFT (ERC721)")
print("=" * 60)
...
if receipt.status == 1:
    ...
    with open('SOULTOKEN_NFT_DEPLOYMENT.json', 'w') as f:
        json.dump(deployment, f, indent=2)
    
    print("Saved to SOULTOKEN_NFT_DEPLOYMENT.json")
else:
